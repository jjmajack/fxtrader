        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                ...
                @if ($paginator->onFirstPage())
                    <li class="page-item disabled" aria-disabled="true">
                        <span class="page-link d-flex align-items-center justify-content-center">
                            <i class="bi bi-chevron-left me-1" style="font-size: 0.875rem;"></i>
                            @lang('pagination.previous')
                        </span>
                    </li>
                @else
                    <li class="page-item">
                        <a class="page-link d-flex align-items-center justify-content-center" href="{{ $paginator->previousPageUrl() }}" rel="prev">
                            <i class="bi bi-chevron-left me-1" style="font-size: 0.875rem;"></i>
                            @lang('pagination.previous')
                        </a>
                    </li>
                ...
                @if ($paginator->hasMorePages())
                    <li class="page-item">
                        <a class="page-link d-flex align-items-center justify-content-center" href="{{ $paginator->nextPageUrl() }}" rel="next">
                            @lang('pagination.next')
                            <i class="bi bi-chevron-right ms-1" style="font-size: 0.875rem;"></i>
                        </a>
                    </li>
                @else
                    <li class="page-item disabled" aria-disabled="true">
                ...
                <ul class="pagination">
                    ...
                    @if ($paginator->onFirstPage())
                        <li class="page-item disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
                            <span class="page-link d-flex align-items-center justify-content-center" aria-hidden="true">
